	...
	<div class="block block1">
		...
		<div class="usBox">
			<div class="usBox_1">
				...
				<form id="registForm" action="${root }/user?method=register" method="post" name="formUser"
					...
					<table width="100%" border="0" align="left" cellpadding="5"
						...
						<tr>
							...
							<td>
								<input type="text" size="8" name="captcha" id="captcha" class="inputBg" 
									onblur="check_captcha(this.value);" /> 
								<span style="color:#FF0000" id="captcha_notice"> *</span>
						...
						<tr>
							...
							<td>
								<label> 
									...
									我已看过并接受《<a href="javascript:;" style="color:blue" target="_blank">用户协议</a>》
								</label>
							</td>
						</tr>
						<tr align="left">
						...
						<tr>
							<td >&nbsp;&nbsp;&nbsp;</td>
							<td>
								<input name="Submit" type="submit" value="会员注册" />
							</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;</td>
