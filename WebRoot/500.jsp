...
<meta http-equiv="refresh" content="5;url=http://127.0.0.1/${root }">
<style type=text/css>
	...
	<table cellspacing=0 cellpadding=0 width=540 align=center border=0>
        ...
        <TR>
          <TD><FONT class=p2>&nbsp;&nbsp;&nbsp; <FONT color=#ff0000><IMG 
            ...
            width=12>&nbsp;无法访问！<span id="s" style="color: orange;font-size: 28px;">5</span>
            			秒后跳到<a href="${root }/index.jsp">首页</a></FONT></FONT></TD></TR>
        <TR>
          <TD height=8></TD>
        <TR>
          <TD>
