				...
				<div class="box_1">
					<div class="userCenterBox boxCenterList clearfix"
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<c:forEach items="${order.oiList }" var="items">
							<tr>
								<td>
									<a href="javascript:;" class="f6">${items.good.name }</a>
								</td>
								<td>${items.good.marketprice }元</td>
								<td>${items.good.estoreprice }元</td>
								<td align="center">${items.buynum }</td>
								<td>${items.buynum * items.good.estoreprice }元</td>
							</tr>
							</c:forEach>
							<tr>
