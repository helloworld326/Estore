...
<script type="text/javascript"
	src="themes/ecmoban_jumei/js/mzp-packed-me.js"></script>
<script type="text/javascript"
	src="themes/ecmoban_jumei/js/good_detail.js"></script>
</head>
<body>
	...
	<div class="block clearfix">
		<div class="AreaR" style="width:950px;">
			...
			<div id="goodsInfo" class="clearfix">
				...
				<div class="imgInfo">
					<!-- 当前显示的大图 -->
					<a href="${root }${good.imgurl}" id="zoom1"
						class="MagicZoom MagicThumb"> <img
						src="${root }${good.imgurl}" width="360px;" height="360px" />
					</a>
					<!-- 下方的图片列表 -->
					<div class="picture" id="imglist">
						<a href="${root }${good.imgurl}" rel="zoom1"
							rev="${root }${good.imgurl}"> <img
							src="${root }${good.imgurl}" class="onbg" />
						</a> <a href="${root }${good.imgurl}" rel="zoom1"
							rev="${root }${good.imgurl}"> <img
							src="${root }${good.imgurl}" class="autobg" />
						</a> <a href="${root }${good.imgurl}" rel="zoom1"
							rev="${root }${good.imgurl}"> <img
							src="${root }${good.imgurl}" class="autobg" />
						</a> <a href="${root }${good.imgurl}" rel="zoom1"
					...
					<script type="text/javascript">mypicBg();
					</script>
				</div>
				<!-- 商品文字信息 -->
				<div class="textInfo">
					...
					<ul class="ul2 clearfix">
						<li class="clearfix">
							<dd>
								<strong>市场售价：</strong> <font class="market">${good.marketprice }元</font>
							</dd>
						</li>
						<li class="clearfix">
							<dd>
								<strong>本店售价：</strong> <font class="shop">${good.estoreprice }元</font>
							</dd>
						</li>
						<li class="clearfix">
							<dd>
						...
						<li class="clearfix" style="width:100%;">
							<dd>
								<strong>商品描述：</strong>
								<div style="text-indent: 2em;">${good.description }</div>
							</dd>
						</li>
					</ul>
					<br />
					<ul class="bnt_ul">
						<li>
							<a href="${root}/cart?method=addToCart&gid=${good.id }"><input type="button" value="添加至购物车" class="btn" /></a>
						</li>
					</ul>
				</div>
			</div>
			...
			<script type="text/javascript">reg("com");
			</script>
			<div class="blank"></div>
			<div class="box">
				<div class="box_1">
					...
					<div class="boxCenterList clearfix ie6" style="padding:2px;">
						...
						<div class="goodsItem" style="padding: 10px 2px 15px 2px;">
							...
							<p>
								<a href="javascript:;" title="完美芦荟胶一对 40g*2">完美芦荟胶一对 40g*2</a>
							</p>
							<font class="shop_s">110元</font>
						</div>
						<div class="goodsItem" style="padding: 10px 2px 15px 2px;">
