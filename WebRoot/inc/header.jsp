...
<div id="Top">
	...
	<div class=" block header_bg" style="margin-bottom:0px;">
		<div class="top_nav_header">
			<div class="top_nav">
				...
				<div class="block">
					<div class="f_l left_login">
						...
						<c:if test="${user != null }">
							<font id="ECS_MEMBERZONE">
								<a style="color:blue;"> 欢迎光临本店，${user.username } ! </a>
					...
					<div class="header_r">
						<a href="${root }/order?method=findAll">我的订单</a>
						<a href="${root }/good?method=findAll">商品列表</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="header_top logo_wrap clearfix">
			...
			<div class="ser_n">
				<form id="searchForm" class="searchBox clearfix" name="searchForm" onsubmit="return false;" method="get" action="">
					<span class="ipt1">
						<input name="keywords" placeholder="请输入您想购买的商品" type="text" onkeyup="_search(this)" id="keyword" value="" class="searchKey" />
					</span>
					<span class="ipt2"><input type="submit" name="imageField" class="fm_hd_btm_shbx_bttn" value="搜  索"></span>
				</form>
				<div class="clear_f"></div>
			...
			<ul class="cart_info">
				<li id="ECS_CARTINFO">
					<div class="top_cart">
						...
						<a href="${root}/cart?method=listCart" class="shopborder">去购物车结算</a>
					</div>
				</li>
			</ul>
		</div>
